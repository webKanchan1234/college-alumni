...
exports.registerUser = asyncHandler(async (req, res) => {
    const { name, email, password, degree, gratuation, location, department, skill, language, avatar } = req.body

    const user = await User.create({
        name, email, password, degree, gratuation, location, department, skill, language,avatar
    })
